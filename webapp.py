...
def login_github():
    ...
    return github.authorize_github(callback=url_for('authorized', _external=True, _scheme='https'))

@app.route('/login/google')
def login_google():
    #collection.update_many({}, {"$set": {"replys": []}})
    return google.authorize_google(callback=url_for('authorized', _external=True, _scheme='https'))
